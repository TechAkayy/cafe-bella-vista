                ...
                <v-menu>
                    <template #activator="{ props }">
                        <v-btn text="My Button" :icon="true" v-bind="props" variant="tonal" class="md:ml-2">
                            <v-avatar alt="Avatar" image="https://avatars.githubusercontent.com/u/73772701?v=4" size="large"></v-avatar>
                        </v-btn>
                    </template>
                        ...
                        <v-list>
                            <v-list-item>
                                <div class="flex flex-col items-center my-1 space-x-1 w-full">
                                    ...
                                    <v-btn class="font-bold my-4 w-fit md:my-2">Sign In / Join Us</v-btn>
                                </div>
                            </v-list-item>
                        </v-list>
                        <v-divider></v-divider>
